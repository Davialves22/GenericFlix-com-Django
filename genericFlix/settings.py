"""
Django settings for genericFlix project.
...
SECRET_KEY = 'django-insecure-shhf+mw)5ik9u)$98q(kv@&a3%wxh6j^smsx-_@$!swarksv(k'
...
WSGI_APPLICATION = 'genericFlix.wsgi.application'
